<div   style="border: 2px solid #E1E6EA;padding: 10px 15px 10px 15px;max-width: 600px;justify-content: center"  >
    ...
    <p>
        ¡Hola <?=$usuario->nom_usuario?>!. Su pedido está siendo procesado, y puede hacerle seguimiento desde nuestra página web. A continuación, le proporcionamos las credenciales correspondientes:
        <br>
        <br>
